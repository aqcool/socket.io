...
Start with the [upgrade guide](docs/UPGRADE.md), the module-specific README files, and the [examples](examples).
...
The [Issues](https://github.com/aqcool/socket.io/issues) section is only for confirmed bugs or feature requests.

For general help or implementation questions:

- Read the [documentation](docs)
- Ask in [Discussions → Q&A](https://github.com/aqcool/socket.io/discussions/new?category=q-a)
...
Thanks to all [contributors](https://github.com/aqcool/socket.io/graphs/contributors) who make this project better ❤️

---

## 🗺 Roadmap

Planned protocol, reliability, observability, adapter, and Go API improvements are tracked in the [functional roadmap](ROADMAP.md).
