module github.com/aqcool/socket.io/adapters/redis/v4

go 1.26.0

require (
	github.com/aqcool/socket.io/adapters/adapter/v4 v4.0.0
	github.com/aqcool/socket.io/parsers/socket/v4 v4.0.0
	github.com/aqcool/socket.io/reliability/v4 v4.0.0
	github.com/aqcool/socket.io/servers/engine/v4 v4.0.0
...
require (
	...
	github.com/aqcool/socket.io/clients/engine/v4 v4.0.0 // indirect
	github.com/aqcool/socket.io/clients/socket/v4 v4.0.0 // indirect
...
replace (
	...
	github.com/aqcool/socket.io/reliability/v4 => ../../reliability
...
replace github.com/aqcool/socket.io/adapters/broker/v4 => ../broker
