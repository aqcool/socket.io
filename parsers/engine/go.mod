module github.com/aqcool/socket.io/parsers/engine/v4

go 1.26.0

require github.com/aqcool/socket.io/v4 v4.0.0
...
replace github.com/aqcool/socket.io/v4 => ../..
...
replace github.com/aqcool/socket.io/parsers/socket/v4 => ../socket

replace github.com/aqcool/socket.io/reliability/v4 => ../../reliability

replace github.com/aqcool/socket.io/servers/engine/v4 => ../../servers/engine
