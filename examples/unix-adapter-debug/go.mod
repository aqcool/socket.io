module github.com/aqcool/socket.io/examples/unix-adapter-debug

go 1.26.0

require (
	github.com/aqcool/socket.io/adapters/adapter/v4 v4.0.0
	github.com/aqcool/socket.io/adapters/unix/v4 v4.0.0
...
replace (
	...
	github.com/aqcool/socket.io/adapters/unix/v4 => ../../adapters/unix
