module github.com/aqcool/socket.io/examples/basic-crud-application

go 1.26.0

require (
	github.com/aqcool/socket.io/clients/socket/v4 v4.0.0
...
replace (
	github.com/aqcool/socket.io/adapters/adapter/v4 => ../../adapters/adapter
	github.com/aqcool/socket.io/adapters/redis/v4 => ../../adapters/redis
...
replace github.com/aqcool/socket.io/examples/test-suite => ../test-suite
