module github.com/aqcool/socket.io/clients/socket/v4

go 1.26.0

require (
	github.com/aqcool/socket.io/clients/engine/v4 v4.0.0
...
replace (
	github.com/aqcool/socket.io/clients/engine/v4 => ../engine
